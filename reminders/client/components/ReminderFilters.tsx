...
interface ReminderFiltersProps {
  ...
  showPaginationSettings?: boolean;
}
  ...
  return (
    <div className='bg-gray-900 border border-gray-800 rounded-lg shadow-lg p-6 mb-6'>
      <div className='flex flex-col gap-4'>
        ...
        {/* Bottom Row: Pagination Settings (if enabled) */}
        {showPaginationSettings && pageLimit && onPageLimitChange && (
...
export default memo(ReminderFilters);
